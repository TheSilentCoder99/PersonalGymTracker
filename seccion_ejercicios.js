let ejerciciosPredeterminados = [
  { nombre: "Press banca", musculo: "Pecho", descripcion: "Ejercicio básico de empuje horizontal. Ideal para desarrollar fuerza y masa en el pectoral mayor.", imagenes: ["ejercicios_predeterminados/press_banca.jpeg"] },
  { nombre: "Banca inclinada", musculo: "Pecho alto", descripcion: "Variante del press banca con banco inclinado. Enfoca el trabajo en la parte alta del pectoral y el deltoides anterior.", imagenes: ["ejercicios_predeterminados/banca_inclinada.webp"]},
  { nombre: "Press militar", musculo: "Hombros", descripcion: "Elevación de barra por encima de la cabeza de pie o sentado. Clave para la fuerza del hombro y el desarrollo del deltoides.", imagenes: ["ejercicios_predeterminados/press_militar.webp"] },
  { nombre: "Fondos lastrados", musculo: "Tríceps", descripcion: "Fondos en paralelas con peso extra. Excelente para tríceps y parte inferior del pecho.", imagenes: ["ejercicios_predeterminados/fondos_lastrados.jpg"]},
...
lista.forEach(dato => {
    ...
    if (dato.imagenes && dato.imagenes.length > 0) {
       ...
       dato.imagenes.forEach(imagen => {
        const url = imagen instanceof File
        ? URL.createObjectURL(imagen)
        : imagen; // ya es un string con la ruta
